...
class MongoConfig {
    ...
    * */
    ...
    @Bean(name = ["chat"])
    @ConfigurationProperties(prefix = "mongodb.chat")
    fun getChat(): MongoProperties = MongoProperties()
...
//    ---------
    ...
    @Bean
    fun chatFactory(mongo: MongoProperties): MongoDatabaseFactory =
...
//    ---------
    ...
    fun chatMongoTemplate(): MongoTemplate = MongoTemplate(
        chatFactory(getChat()), mappingMongoConverter()
    )
}